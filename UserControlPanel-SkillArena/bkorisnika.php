				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Brisanje korisnika</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									<form action="bkorisnikap.php" method="POST">
...
<br><br>
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											while($nFetch = mysql_fetch_object($nResult))
											{
												...
												$id = $id+1;
												$linker = "brisi.php?sid=" . $nFetch->ID ."&hash=kk71930dl";
											...
											echo'
												<tr>
													...
													<td class="center">
													<a href="' . $linker . '"> <button class="btn btn-danger">
													<i>Brisanje</i>
													</button></a>
													</td>
										...
										<?php $prethodna = $sid-1;
												...
												if($iduca*25 > $maksimalna)
													$iduca = $sid;
										?>
										<a href="bkorisnika.php?sid=<?php echo $prethodna ?>"> <button class="btn btn-danger">
							<i>Prethodna stranica</i>
						</button></a>
						<a href="bkorisnika.php?sid=<?php echo $iduca ?>"><button class="btn btn-success">
