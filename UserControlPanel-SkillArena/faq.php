...
<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Pomoć</li>

							

							<li class="active">FAQ - Često postavljena pitanja</li>
	...
	<ul style="list-style: none;" class="cd-faq-categories">
	...
	<div class="cd-faq-items">
		<ul id="basics" style="list-style: none;" class="cd-faq-group">
			<h5>Basics</h5>
			<li>
		...
		<ul id="mobile" style="list-style: none;" class="cd-faq-group">
			<h5>Mobile</h5>
			<li>
		...
		<ul id="account" style="list-style: none;" class="cd-faq-group">
			<h5>Account</h5>
			<li>
				<a class="cd-faq-trigger" href="#0">How do I change my password?</a>
				<div class="cd-faq-content">
		...
		<ul id="payments" style="list-style: none;" class="cd-faq-group">
			<h5>Payments</h5>
			<li>
		...
		<ul id="privacy" style="list-style: none;" class="cd-faq-group">
			<h5>Privacy</h5>
			<li>
		...
		<ul id="delivery" style="list-style: none;" class="cd-faq-group">
			<h5>Delivery</h5>
			<li>
