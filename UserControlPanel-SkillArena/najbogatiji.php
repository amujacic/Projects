				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Najbogatiji igrači</li>
						</ul><!-- /.breadcrumb -->
								...
								<div class="row">
									<div class="col-xs-12">
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<?php
											include "baza.php";
											$nQuery = "SELECT * FROM `" . $_UsersTable ."` ORDER BY (NovacDzep+NovacBanka) DESC LIMIT 25";
										...
										$id = $id+1;
												...
												$bogatstvo = $nFetch->NovacDzep + $nFetch->NovacBanka;
											echo'
												<tr>
													<td class="center">
													' .$id. '	
													...
													<td class="center">' .number_format($bogatstvo) . '$</td>
