				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<?php
									...
									include "baza.php";		
									$korQuery = "SELECT * FROM `" . $_UsersTable ."` WHERE Playername = '" . $_COOKIE['user'] . "'";
									$korResult = mysql_query($korQuery) or die(mysql_error());
									$korFetch = mysql_fetch_object($korResult);
...
<br><br>
								<div class="row">
									...
									<?php
									include "baza.php";
									$szQuery = "SELECT * FROM `aukcija` ORDER BY id DESC";
									$qResult = mysql_query($szQuery) or die(mysql_error());
									$maksimalna = mysql_num_rows($qResult);
									$limit1 = $sid*25;
									$strprije = $sid-1;
									$limit2 = $strprije*25;
									$szQuery = "SELECT * FROM `aukcija` ORDER BY id DESC LIMIT " . $limit2 ."," . $limit1 ."";
									$qResult = mysql_query($szQuery) or die(mysql_error());
									$VehicleName = Array(
										400 => 'Landstalker', 401 => 'Bravura', 402 => 'Buffalo', 403 => 'Linerunner', 404 => 'Perenail', 405 => 'Sentinel', 406 => 'Dumper', 407 => 'Firetruck', 408 => 'Trashmaster', 409 => 'Stretch', 410 => 'Manana', 411 => 'Infernus', 412 => 'Voodoo', 413 => 'pony', 414 => 'Mule', 415 => 'Cheetah', 416 => 'Ambulance', 417 => 'Levetian', 418 => 'Boonbeam', 419 => 'Esperanto', 420 => 'Taxi', 421 => 'Washington', 422 => 'Bobcat', 423 => 'Mr whoopee', 424 => 'BF injection', 425 => 'Hunter', 426 => 'Premier', 427 => 'Enforcer', 428 => 'Securicar', 429 => 'Banshee', 430 => 'Predator', 431 => 'Bus', 432 => 'Rhino', 433 => 'Barracks', 434 => 'Hotknife', 435 => 'Artic trailer 1', 436 => 'Previon', 437 => 'Coach', 438 => 'Cabbie', 439 => 'Stallion', 440 => 'Rumpo', 441 => 'RC bandit',
										442 => 'Romero', 443 => 'Packer', 444 => 'Monster', 445 => 'Admiral', 446 => 'Squalo', 447 => 'Seasparrow', 448 => 'Pizza boy', 449 => 'Tram', 450 => 'Artic trailer 2', 451 => 'Turismo', 452 => 'Speeder', 453 => 'Reefer', 454 => 'Tropic', 455 => 'Flatbed', 456 => 'Yankee', 457 => 'Caddy', 458 => 'Solair', 459 => 'Top fun', 460 => 'Skimmer', 461 => 'PCJ 600', 462 => 'Faggio', 463 => 'Freeway', 464 => 'RC baron', 465 => 'RC raider', 466 => 'Glendale', 467 => 'Oceanic', 468 => 'Sanchez', 469 => 'Sparrow', 470 => 'Patriot', 471 => 'Quad', 472 => 'Coastgaurd', 473 => 'Dinghy', 474 => 'Hermes', 475 => 'Sabre', 476 => 'Rustler', 477 => 'ZR 350', 478 => 'Walton', 479 => 'Regina', 480 => 'Comet', 481 => 'BMX', 482 => 'Burriro', 483 => 'Camper', 484 => 'Marquis', 485 => 'Baggage', 
										...
										if($rFetch->VrstaImovine == 1 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeKuce == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeKuce != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 2 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeStana == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeStana != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 3 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeVikendice == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeVikendice != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 4 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeAuta == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeAuta != -1 && $korFetch->DvaA == 1 && $korFetch->PosedovanjeAuta2 == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeAuta != -1) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 6 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeMotora == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeMotora != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 7 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjePlovila == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjePlovila != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
										...
										if($rFetch->VrstaImovine == 8 )
										{
											...
											echo'
												<tr>
													...
													<td class="center">' . $rFetch->IgracPonudio . '</td>
													';
													if($korFetch->PosedovanjeAviona == -1 ) echo'<td class="center"><a href="#openModal-auid=' . $rFetch->id . '"> <button class="btn btn-success"><i>Biduj</i></button></a></td>';
													if($korFetch->PosedovanjeAviona != -1 ) echo'<td class="center"><a href=""> <button class="btn btn-grey"><i>Biduj</i></button></a></td>';
												echo'</tr>';
										echo '
									...
									?>
										...
										<?php $prethodna = $sid-1;
												...
												if($iduca*25 > $maksimalna)
													$iduca = $sid;
										?>
										<a href="aukcije.php?sid=<?php echo $prethodna ?>"> <button class="btn btn-danger">
							<i>Prethodna stranica</i>
						</button></a>
						<a href="aukcije.php?sid=<?php echo $iduca ?>"><button class="btn btn-success">
