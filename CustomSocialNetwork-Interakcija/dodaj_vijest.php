...
<head>
    <meta charset="utf-8">
    <title>Interakcija | Dodavanje novosti</title>
           ...
           <div class="twelve columns">
                ...
                <hr>
				 <div class="block">
                    ...
                    <div class = "color">
                        <form method="post" action="dodaj_v.php">
  <p>
    <input type="text" name="naslov" id="naslov" placeholder="Naslov" required />
  </p><br>
  <p>
    <input type="text" name="opis" id="opis" placeholder="Kratak opis" required/>
  </p><br>
  <p>
    <input type="text" name="objavio" id="objavio" placeholder="Objavio" required/>
  </p><br>
  <p>
    <input type="text" name="datum" id="datum" placeholder="Datum" required/>
  </p><br>
  <p>
    <textarea name="tekst" cols="100" rows="10" id="tekst" placeholder="Tekst vijesti" required></textarea>
  </p><br>
  <p>
    <input type="text" name="slika" id="slika" placeholder="Direktan link do slike" required />
  </p><br>
  <p>
     <input type="submit" value="Dodaj vijest" class="background-color gray-box-submit comment-sender">
  </p>
</form>
 <?php
...
if ($remarks=='success')
{
echo '<font color="green">Vijest uspješno dodana!</font>';
}
?>	<br><br><br>
                    </div>
